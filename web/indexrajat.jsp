...
<div class="custom-control custom-radio float-left">
  <input type="radio" class="custom-control-input" id="defaultChecked" name="defaultExampleRadios" name="instructor" value="instructor" >
  ...
  <script type="text/javascript">
   $(document).ready(function(){
     ...
     submitHandler: function(form) {
       ...
       admin=document.getElementById("myRadio").value;
       console.log(admin);
      datastring="username="+user+"&password="+password+"&admin="+admin;
      $.ajax({
          ...
          success:function(result){
              console.log(result);
              if(result=="ok"&&admin!=null){
              location.href="Dashboard1.jsp";
          }else if(result=="ok"&&admin==null){
              location.href="Dashboard2.jsp";
          }else{
              out.println("username and password doesnot matched");
          }
          }
      });
},
