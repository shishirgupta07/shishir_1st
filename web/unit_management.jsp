...
<body>
     <ul id="slide-out" class="side-nav fixed custom-scrollbar " style="background-color:#4b3e8a; transform: translateX(0%);">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                    <li><a class="collapsible-header waves-effect arrow-r" href="Dashbaord2.jsp"><i class="fa fa-home  white-text"></i>&nbsp&nbsp&nbsp&nbsp&nbsp Home<i class="fa fa-angle-down rotate-icon"></i></a>
    ...
    <div class="container"> 
                    ...
                    <br>
                      <ul class="nav nav-tabs nav-justified md-tabs" style="background-color: #4b3e8a" id="myTabJust" role="tablist">
                           <li class="nav-item">
                                ...
                                aria-selected="true">view Units</a>
                          </li>
                            <li class="nav-item">
                            <a class="nav-link" id="profile-tab-just" data-toggle="tab" href="#profile-just" role="tab" aria-controls="profile-just"
                                  aria-selected="false">add Units</a>
                              </li>
                    </ul>
      ...
      <!-- Editable table -->
                       <div class="card "  >
                                             <h5 style="background-color:#4b3e8a" class="card-header  text-center white-text font-weight-bold text-uppercase py-4 ">View Units </h5>
                              <div class="card-body">
 ...
 <div class="tab-pane fade" id="profile-just" role="tabpanel" aria-labelledby="profile-tab-just">
      ...
      <!-- Material form subscription -->
        <div class="card">
                    ...
                    <strong>Add Units here</strong>
                    </h5>
         <div class="card-body px-lg-5">

  <!-- Form -->      
  <form class="text-center" id="loginform" action="unit_add.jsp" style="color: #757575" method="get" >
 ...
 %>
              ...
              <tr>
                  <td>
                      ...
                      <span class="input-group-text md-addon" id="inputGroupMaterial-sizing-default">enter the no of units you want to enter</span>
                      </div>
                      <input type="text" class="form-control" id="textField" name="units" aria-label="Sizing example input" aria-describedby="inputGroupMaterial-sizing-default" onkeyup="generate()">
                      </div>
                   </td>
              </tr>
              <tr>
       ...
       function generate(){
           console.log("chalu ho gaya");
            ...
            for (i=1;i<=number;i++){
                ...
                container.appendChild(document.createTextNode("unit No"));
                var input1 = document.createElement("input");
                input1.type = "text";
                input1.name = "noField"+i;
                container.appendChild(input1);
                // Create an <input> element, set its type and name attributes
                container.appendChild(document.createTextNode("unit Name"));
                var input2 = document.createElement("input");
                input2.type = "text";
                input2.name = "unitField"+i;
     ...
     $(document).ready(function(){
         $('#subject_select').change(function(){
          $('#unit_print').find('td').remove();
                ...
                var datastring={course_id:course_id,sem_id:sem_id,subject_id:subject_id};
                  $.ajax({
      type:"POST",
      url:"getUnit.jsp",
      data:datastring,
      ...
      {
        console.log(result);
        var end= $('#unit_print').find('td').remove().end();
       end.append(result);
   }
