               ...
               <td>
                ...
                <span class="table-remove  white-text"><a href="edit2.jsp?idc=<%= rss.getString("courseid")%>"><button type="button" style="background-color:#4b3e8a; color:white "
                  ...
                  <span class="table-remove white-text"><!-- Button trigger modal -->
                        <button type="button" style="background-color:#4b3e8a; color:white " class=" btn-rounded btn-sm" data-toggle="modal" data-target="#basicExampleModal">
                        Remove
                        </button>
                               ...
                               <div class="modal-content">
                                     ...
                                     <div class="modal-body">
                                       ...
                                       <div class="modal-footer">
                                        ...
                                        <a href="remove.jsp?id=<%= rss.getString("courseid")%>"> <button type="button" class="btn btn-primary btn-rounded btn-sm">delete</button> </a>
                                        </div>
                               </div>
                     </div>
                </div></span>
