...
<div class="card">
    ...
    <div class="card-body px-lg-5">
        ...
        <!-- Form -->
        <form class="text-center" action="update2.jsp" style="color: #757575;" method="post">

            <%
            String uid= request.getParameter("idc");
            System.out.println(uid);
            SqlUtil.connectDatabase();
            String sql="Select * from course where courseid='"+uid+"' ";
          ...
          <div class="col-lg-4">
            <div class="md-form"> 
                ...
                <input type="text" id="materialSubscriptionFormCourseName" name="course" value="<%=rs.getString("course")%>" class="form-control">
            ...
            <div class="md-form"> 
                <div class="row">
                        ...
                        <input type="text" id="materialSubscriptionFormDuration" value="<%= rs.getString("duration")%>" name="duration" class="form-control">
            ...
            <div class="md-form"> 
                <div class="row">
                        ...
                        <input type="text" id="materialSubscriptionFormcourseid" value="<%= rs.getString("courseid")%>"  name="courseid" class="form-control"  readonly>
